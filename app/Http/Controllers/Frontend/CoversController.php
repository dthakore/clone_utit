...
class CoversController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.covers.index', compact('covers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.covers.create', compact('bots'));
    }
    ...
    public function store(StoreCoverRequest $request)
    {
        ...
        return redirect()->route('frontend.covers.index');
    }
    ...
    public function edit(Cover $cover)
    {
        ...
        return view('frontend.covers.edit', compact('bots', 'cover'));
    }
