...
<body>
    <div id="app">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item {{ request()->routeIs('frontend.wallet') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('frontend.wallet') }}">
                                    {{ __('My Wallet') }}
                                </a>
                            </li>
                        @endguest
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('rank_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.ranks.index') }}">
                                    ...
                                    @endcan
                                    @can('exchange_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.exchanges.index') }}">
                                            {{ trans('cruds.exchange.title') }}
                                        </a>
                                    @endcan
                                    @can('user_exchange_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.user-exchanges.index') }}">
                                            {{ trans('cruds.userExchange.title') }}
                                        </a>
                                    @endcan
                                    @can('symbol_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.symbols.index') }}">
                                            {{ trans('cruds.symbol.title') }}
                                        </a>
                                    @endcan
                                    @can('bot_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.bots.index') }}">
                                    ...
                                    @endcan
                                    @can('trade_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.trades.index') }}">
                                            {{ trans('cruds.trade.title') }}
                                        </a>
                                    @endcan
                                    @can('cover_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.covers.index') }}">
                                    ...
                                    @can('commission_rule_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.commission-rules.index') }}">
                                    ...
                                    @can('shipment_info_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.shipment-infos.index') }}">
                                            {{ trans('cruds.shipmentInfo.title') }}
                                        </a>
                                    @endcan
                                    @can('order_credit_memo_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.order-credit-memos.index') }}">
                                    ...
                                    @can('mt_four_broker_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.mt-four-brokers.index') }}">
                                            {{ trans('cruds.mtFourBroker.title') }}
                                        </a>
                                    @endcan
                                    @can('cbm_mt_four_account_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.cbm-mt-four-accounts.index') }}">
                                            {{ trans('cruds.cbmMtFourAccount.title') }}
                                        </a>
                                    @endcan
                                    @can('mt_four_deposit_withdraw_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.mt-four-deposit-withdraws.index') }}">
                                            {{ trans('cruds.mtFourDepositWithdraw.title') }}
                                        </a>
                                    @endcan
                                    @can('mt_four_trade_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.mt-four-trades.index') }}">
                                    ...
                                    @can('denomination_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.denominations.index') }}">
                                            {{ trans('cruds.denomination.title') }}
                                        </a>
                                    @endcan
                                    @can('wallet_meta_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.wallet-meta-types.index') }}">
                                            {{ trans('cruds.walletMetaType.title') }}
                                        </a>
                                    @endcan
                                    @can('wallet_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.wallet-types.index') }}">
                                            {{ trans('cruds.walletType.title') }}
                                        </a>
                                    @endcan
                                    @can('allwallettransaction_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.allwallettransactions.index') }}">
                                    ...
                                    @can('user_position_account_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.user-position-accounts.index') }}">
        ...
        <main class="py-4" style="background-color: #ebedef;">
            @if(session('message'))
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
