...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.mt-four-brokers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('server_login') ? 'is-invalid' : '' }}" type="number" name="server_login" id="server_login" value="{{ old('server_login', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('server_password') ? 'is-invalid' : '' }}" type="text" name="server_password" id="server_password" value="{{ old('server_password', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('server_address') ? 'is-invalid' : '' }}" type="text" name="server_address" id="server_address" value="{{ old('server_address', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('server_port') ? 'is-invalid' : '' }}" type="number" name="server_port" id="server_port" value="{{ old('server_port', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agent') ? 'is-invalid' : '' }}" type="number" name="agent" id="agent" value="{{ old('agent', '') }}" step="1">
                @if($errors->has('agent'))
                    <div class="invalid-feedback">
                        {{ $errors->first('agent') }}
                    </div>
