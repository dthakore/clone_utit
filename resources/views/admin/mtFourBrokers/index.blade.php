...
@can('mt_four_broker_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.mt-four-brokers.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-MtFourBroker">
            <thead>
                <tr>
                    <th width="10">
...
@can('mt_four_broker_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.mt-four-brokers.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.mt-four-brokers.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'name', name: 'name' },
{ data: 'server_login', name: 'server_login' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-MtFourBroker').DataTable(dtOverrideGlobals);
