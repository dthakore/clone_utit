...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shipment-infos.update", [$shipmentInfo->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="order">{{ trans('cruds.shipmentInfo.fields.order') }}</label>
                <input class="form-control {{ $errors->has('order') ? 'is-invalid' : '' }}" type="text" name="order" id="order" value="{{ old('order', $shipmentInfo->order) }}">
                @if($errors->has('order'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipment_number') ? 'is-invalid' : '' }}" type="text" name="shipment_number" id="shipment_number" value="{{ old('shipment_number', $shipmentInfo->shipment_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tracking_number') ? 'is-invalid' : '' }}" type="text" name="tracking_number" id="tracking_number" value="{{ old('tracking_number', $shipmentInfo->tracking_number) }}">
