...
@can('shipment_info_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.shipment-infos.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ShipmentInfo">
            <thead>
                <tr>
                    <th width="10">
...
@can('shipment_info_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.shipment-infos.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.shipment-infos.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ShipmentInfo').DataTable(dtOverrideGlobals);
