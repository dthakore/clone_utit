...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.exchanges.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="form-check {{ $errors->has('is_visible') ? 'is-invalid' : '' }}">
                                ...
                                <input class="form-check-input" type="checkbox" name="is_visible" id="is_visible" value="1" {{ old('is_visible', 0) == 1 ? 'checked' : '' }}>
