                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('tag') ? 'is-invalid' : '' }}" type="text" name="tag" id="tag" value="{{ old('tag', $product->tag) }}" required>
                            @if($errors->has('tag'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tag') }}
                                </div>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('level_one_affiliate') ? 'is-invalid' : '' }}" type="number" name="level_one_affiliate" id="level_one_affiliate" value="{{ old('level_one_affiliate', $product->level_one_affiliate) }}"  step="0.01">
                            @if($errors->has('level_one_affiliate'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('level_one_affiliate') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.product.fields.level_one_affiliate') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('level_two_affiliate') ? 'is-invalid' : '' }}" type="number" name="level_two_affiliate" id="level_two_affiliate" value="{{ old('level_two_affiliate', $product->level_two_affiliate) }}"  step="0.01">
                            @if($errors->has('level_two_affiliate'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('level_two_affiliate') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.product.fields.level_two_affiliate') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control datetime {{ $errors->has('sale_start_date') ? 'is-invalid' : '' }}" type="text" name="sale_start_date" id="sale_start_date" value="{{ old('sale_start_date', $product->sale_start_date) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control datetime {{ $errors->has('sale_end_date') ? 'is-invalid' : '' }}" type="text" name="sale_end_date" id="sale_end_date" value="{{ old('sale_end_date', $product->sale_end_date) }}">
