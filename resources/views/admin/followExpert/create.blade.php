...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} Expert
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route("admin.experts.store") }}" enctype="multipart/form-data" id="user-form">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="name" class="required">{{ trans('cruds.followExpert.fields.name') }}</label>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="account" class="required">{{ trans('cruds.followExpert.fields.account') }}</label>
                            <input class="form-control {{ $errors->has('account') ? 'is-invalid' : '' }}" type="text" name="account" id="account" value="{{ old('account', '') }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="type">{{ trans('cruds.followExpert.fields.type') }}</label>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="broker">{{ trans('cruds.followExpert.fields.broker') }}</label>
                            <select class="form-control {{ $errors->has('broker') ? 'is-invalid' : '' }}" name="broker" id="broker" >
                                ...
                                @foreach(App\Models\Expert::BROKER_TYPE as $key => $label)
                                    <option value="{{ $key }}" {{ old('broker', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="asset_manager">{{ trans('cruds.followExpert.fields.asset_manager') }}</label>
                            <select class="form-control {{ $errors->has('asset_manager') ? 'is-invalid' : '' }}" name="asset_manager" id="asset_manager">
                                ...
                                @foreach(App\Models\Expert::ASSET_MANAGER as $key => $label)
                                    <option value="{{ $key }}" {{ old('asset_manager', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('asset_type') ? 'is-invalid' : '' }}" type="text" name="asset_type" id="asset_type" value="{{ old('asset_type', '') }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('total_investors') ? 'is-invalid' : '' }}" type="text" name="total_investors" id="total_investors" value="{{ old('total_investors', '') }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('aum') ? 'is-invalid' : '' }}" type="text" name="aum" id="aum" value="{{ old('aum', '') }}">
                            @if($errors->has('aum'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('aum') }}
                                </div>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="is_forex">{{ trans('cruds.followExpert.fields.is_forex') }}</label>
                            <select class="form-control {{ $errors->has('is_forex') ? 'is-invalid' : '' }}" name="is_forex" id="is_forex" >
                                ...
                                @foreach(App\Models\Expert::IS_FOREX as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_forex', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="is_verified">{{ trans('cruds.followExpert.fields.is_verified') }}</label>
                            <select class="form-control {{ $errors->has('is_verified') ? 'is-invalid' : '' }}" name="is_verified" id="is_verified">
                                ...
                                @foreach(App\Models\Expert::IS_VERIFIED as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_verified', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="is_manual_trader">{{ trans('cruds.followExpert.fields.is_manual_trader') }}</label>
                            <select class="form-control {{ $errors->has('is_manual_trader') ? 'is-invalid' : '' }}" name="is_manual_trader" id="is_manual_trader">
                                ...
                                @foreach(App\Models\Expert::IS_MANUAL_TRADER as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_manual_trader', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="currency">{{ trans('cruds.followExpert.fields.currency') }}</label>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('performance_fee') ? 'is-invalid' : '' }}" type="text" name="performance_fee" id="performance_fee" value="{{ old('performance_fee', '') }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('abs_gain') ? 'is-invalid' : '' }}" type="text" name="abs_gain" id="abs_gain" value="{{ old('abs_gain', '') }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('max_dd') ? 'is-invalid' : '' }}" type="text" name="max_dd" id="max_dd" value="{{ old('max_dd', '') }}">
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
        $(".expertIconsImg").dropzone({
            maxFiles: 2000,
            url: "{{ route('admin.experts.storeMedia') }}",
            headers: {
