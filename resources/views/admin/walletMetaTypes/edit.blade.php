...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.walletMetaType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.wallet-meta-types.update", [$walletMetaType->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('reference_key') ? 'is-invalid' : '' }}" type="text" name="reference_key" id="reference_key" value="{{ old('reference_key', $walletMetaType->reference_key) }}" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('reference_desc') ? 'is-invalid' : '' }}" type="text" name="reference_desc" id="reference_desc" value="{{ old('reference_desc', $walletMetaType->reference_desc) }}" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('reference_data') ? 'is-invalid' : '' }}" type="text" name="reference_data" id="reference_data" value="{{ old('reference_data', $walletMetaType->reference_data) }}" required>
