                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('lowest') ? 'is-invalid' : '' }}" type="number" name="lowest" id="lowest" value="{{ old('lowest', $session->lowest) }}" step="0.01">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('highest') ? 'is-invalid' : '' }}" type="number" name="highest" id="highest" value="{{ old('highest', $session->highest) }}" step="0.01">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('last_buy') ? 'is-invalid' : '' }}" type="number" name="last_buy" id="last_buy" value="{{ old('last_buy', $session->last_buy) }}" step="0.01">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('average_buy') ? 'is-invalid' : '' }}" type="number" name="average_buy" id="average_buy" value="{{ old('average_buy', $session->average_buy) }}" step="0.01">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('total_buy') ? 'is-invalid' : '' }}" type="number" name="total_buy" id="total_buy" value="{{ old('total_buy', $session->total_buy) }}" step="1">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('cover') ? 'is-invalid' : '' }}" type="number" name="cover" id="cover" value="{{ old('cover', $session->cover) }}" step="1">
                            @if($errors->has('cover'))
