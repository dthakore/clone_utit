...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.wallet-types.update", [$walletType->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('wallet_type') ? 'is-invalid' : '' }}" type="text" name="wallet_type" id="wallet_type" value="{{ old('wallet_type', $walletType->wallet_type) }}" required>
