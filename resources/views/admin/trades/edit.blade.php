...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.trade.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.trades.update", [$trade->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('bot') ? 'is-invalid' : '' }}" name="bot_id" id="bot_id" required>
                                @foreach($bots as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('bot_id') ? old('bot_id') : $trade->bot->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('bot'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('session') ? 'is-invalid' : '' }}" name="session_id" id="session_id">
                                @foreach($sessions as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('session_id') ? old('session_id') : $trade->session->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('symbol') ? 'is-invalid' : '' }}" name="symbol_id" id="symbol_id">
                                @foreach($symbols as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('symbol_id') ? old('symbol_id') : $trade->symbol->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                                @foreach($users as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $trade->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('user'))
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('requested_amount') ? 'is-invalid' : '' }}" type="number" name="requested_amount" id="requested_amount" value="{{ old('requested_amount', $trade->requested_amount) }}" step="0.000001" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('side') ? 'is-invalid' : '' }}" name="side" id="side" required>
                                ...
                                @foreach(App\Models\Trade::SIDE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('side', $trade->side) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('side'))
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('comment') ? 'is-invalid' : '' }}" type="text" name="comment" id="comment" value="{{ old('comment', $trade->comment) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('failure_reason') ? 'is-invalid' : '' }}" type="text" name="failure_reason" id="failure_reason" value="{{ old('failure_reason', $trade->failure_reason) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('exchange_order_status') ? 'is-invalid' : '' }}" type="text" name="exchange_order_status" id="exchange_order_status" value="{{ old('exchange_order_status', $trade->exchange_order_status) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('original_orders') ? 'is-invalid' : '' }}" type="text" name="original_orders" id="original_orders" value="{{ old('original_orders', $trade->original_orders) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('exchange_order_ref') ? 'is-invalid' : '' }}" type="text" name="exchange_order_ref" id="exchange_order_ref" value="{{ old('exchange_order_ref', $trade->exchange_order_ref) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('exchange_trade_ref') ? 'is-invalid' : '' }}" type="text" name="exchange_trade_ref" id="exchange_trade_ref" value="{{ old('exchange_trade_ref', $trade->exchange_trade_ref) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('requested_price') ? 'is-invalid' : '' }}" type="number" name="requested_price" id="requested_price" value="{{ old('requested_price', $trade->requested_price) }}" step="0.000001" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('requested_quantity') ? 'is-invalid' : '' }}" type="number" name="requested_quantity" id="requested_quantity" value="{{ old('requested_quantity', $trade->requested_quantity) }}" step="0.000001" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('executed_price') ? 'is-invalid' : '' }}" type="number" name="executed_price" id="executed_price" value="{{ old('executed_price', $trade->executed_price) }}" step="0.000001" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('executed_amount') ? 'is-invalid' : '' }}" type="number" name="executed_amount" id="executed_amount" value="{{ old('executed_amount', $trade->executed_amount) }}" step="0.000001" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('executed_quantity') ? 'is-invalid' : '' }}" type="number" name="executed_quantity" id="executed_quantity" value="{{ old('executed_quantity', $trade->executed_quantity) }}" step="0.000001" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('cover') ? 'is-invalid' : '' }}" name="cover_id" id="cover_id">
                                @foreach($covers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('cover_id') ? old('cover_id') : $trade->cover->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('cover'))
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="number" name="status" id="status" value="{{ old('status', $trade->status) }}" step="1" required>
