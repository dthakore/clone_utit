                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $payment->type) }}" readonly>
                            @if($errors->has('type'))
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('frontend_label') ? 'is-invalid' : '' }}" type="text" name="frontend_label" id="frontend_label" value="{{ old('frontend_label', $payment->frontend_label) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" name="is_active" id="is_active">
                                ...
                                @foreach(App\Models\Payment::IS_ACTIVE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_active', $payment->is_active) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
