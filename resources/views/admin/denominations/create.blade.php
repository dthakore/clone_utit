...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.denominations.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('denomination_type') ? 'is-invalid' : '' }}" type="text" name="denomination_type" id="denomination_type" value="{{ old('denomination_type', '') }}" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('sub_type') ? 'is-invalid' : '' }}" type="text" name="sub_type" id="sub_type" value="{{ old('sub_type', '') }}" required>
