        ...
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data" id="user-form">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $user->name) }}" required readonly>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('sponsor') ? 'is-invalid' : '' }}" name="sponsor_id" id="sponsor_id" required>
                                @foreach($sponsors as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('sponsor_id') ? old('sponsor_id') : $user->sponsor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('roles') ? 'is-invalid' : '' }}" name="roles" id="roles">
                                @foreach($roles as $id => $role)
                                    <option value="{{ $id }}" {{ (old('roles') ? old('roles') : $user->roles->contains($id) ?? '') == $id ? 'selected' : '' }}>{{ $role }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('roles'))
                                <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>{{ trans('cruds.user.fields.is_enabled') }}</label>
                            <select class="form-control {{ $errors->has('is_enabled') ? 'is-invalid' : '' }}" name="is_enabled" id="is_enabled">
                                <option value disabled {{ old('is_enabled', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                @foreach(App\Models\User::IS_ENABLED_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_enabled', $user->is_enabled) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.user.fields.is_enabled_helper') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" name="is_active" id="is_active">
                                ...
                                @foreach(App\Models\User::IS_ACTIVE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('is_active', $user->is_active) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('product_id') ? 'is-invalid' : '' }}" name="product_id" id="product_id">
                                @foreach($products as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('product_id') ? old('product_id') : $user->product->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="radio" id="business" name="billing_info" value="business" {{ !empty($user->business_name) ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('bus_address_building_num') ? 'is-invalid' : '' }}" type="text" name="bus_address_building_num" id="bus_address_building_num" value="{{ old('bus_address_building_num', $user->bus_address_building_num) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('bus_address_street') ? 'is-invalid' : '' }}" type="text" name="bus_address_street" id="bus_address_street" value="{{ old('bus_address_street', $user->bus_address_street) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('bus_address_region') ? 'is-invalid' : '' }}" type="text" name="bus_address_region" id="bus_address_region" value="{{ old('bus_address_region', $user->bus_address_region) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('bus_address_postcode') ? 'is-invalid' : '' }}" type="text" name="bus_address_postcode" id="bus_address_postcode" value="{{ old('bus_address_postcode', $user->bus_address_postcode) }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('bus_address_city') ? 'is-invalid' : '' }}" type="text" name="bus_address_city" id="bus_address_city" value="{{ old('bus_address_city', $user->bus_address_city) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('bus_address_country') ? 'is-invalid' : '' }}" name="bus_address_country_id" id="bus_address_country_id">
                                @foreach($bus_address_countries as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('bus_address_country_id') ? old('bus_address_country_id') : $user->bus_address_country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('business_phone') ? 'is-invalid' : '' }}" type="text" name="business_phone" id="business_phone" value="{{ old('business_phone', $user->business_phone) }}">
