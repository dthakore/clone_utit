                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('table_name') ? 'is-invalid' : '' }}" type="text" name="table_name" id="table_name" value="{{ old('table_name', '') }}">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('action_name') ? 'is-invalid' : '' }}" type="text" name="action_name" id="action_name" value="{{ old('action_name', '') }}">
