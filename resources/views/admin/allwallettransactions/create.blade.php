...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} Wallet Transaction
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.allwallettransactions.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('reference_num') ? 'is-invalid' : '' }}" type="text" name="reference_num" id="reference_num" value="{{ old('reference_num', '') }}" required>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('transaction_comment') ? 'is-invalid' : '' }}" name="transaction_comment" id="transaction_comment">{{ old('transaction_comment') }}</textarea>
