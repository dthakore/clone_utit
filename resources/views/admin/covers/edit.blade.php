...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.covers.update", [$cover->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('index') ? 'is-invalid' : '' }}" type="number" name="index" id="index" value="{{ old('index', $cover->index) }}" step="1">
                            @if($errors->has('index'))
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('cover_percentage') ? 'is-invalid' : '' }}" type="number" name="cover_percentage" id="cover_percentage" value="{{ old('cover_percentage', $cover->cover_percentage) }}" step="0.01" min="-100">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('buy_x_times') ? 'is-invalid' : '' }}" type="number" name="buy_x_times" id="buy_x_times" value="{{ old('buy_x_times', $cover->buy_x_times) }}" step="1">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('cover_pullback') ? 'is-invalid' : '' }}" type="number" name="cover_pullback" id="cover_pullback" value="{{ old('cover_pullback', $cover->cover_pullback) }}" step="0.01" max="100">
