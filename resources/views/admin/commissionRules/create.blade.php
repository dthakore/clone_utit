                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\CommissionRule::AMOUNT_TYPE_RADIO as $key => $label)
                                <div class="form-check {{ $errors->has('amount_type') ? 'is-invalid' : '' }}">
                                    <input class="form-check-input" type="radio" id="amount_type_{{ $key }}" name="amount_type" value="{{ $key }}" {{ old('amount_type', '') === (string) $key ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', '') }}" step="0.00001" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\CommissionRule::WALLET_STATUS_RADIO as $key => $label)
                                <div class="form-check {{ $errors->has('wallet_status') ? 'is-invalid' : '' }}">
                                    <input class="form-check-input" type="radio" id="wallet_status_{{ $key }}" name="wallet_status" value="{{ $key }}" {{ old('wallet_status', '') === (string) $key ? 'checked' : '' }}>
