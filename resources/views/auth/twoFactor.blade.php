                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('twoFactor.check') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="two_factor_code" type="text" class="form-control{{ $errors->has('two_factor_code') ? ' is-invalid' : '' }}"  autofocus placeholder="{{ trans('global.two_factor.code') }}">
...
<form id="logoutform" action="{{ route('sio.logout') }}" method="POST" style="display: none;">
    {{ csrf_field() }}
</form>
@endsection
