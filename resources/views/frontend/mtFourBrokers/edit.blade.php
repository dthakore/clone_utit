    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.mt-four-brokers.update", [$mtFourBroker->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.mtFourBroker.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $mtFourBroker->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="server_login" id="server_login" value="{{ old('server_login', $mtFourBroker->server_login) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="server_password" id="server_password" value="{{ old('server_password', $mtFourBroker->server_password) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="server_address" id="server_address" value="{{ old('server_address', $mtFourBroker->server_address) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="server_port" id="server_port" value="{{ old('server_port', $mtFourBroker->server_port) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="agent" id="agent" value="{{ old('agent', $mtFourBroker->agent) }}" step="1">
                            @if($errors->has('agent'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('agent') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $mtFourBroker->location) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comment" id="comment">{{ old('comment', $mtFourBroker->comment) }}</textarea>
