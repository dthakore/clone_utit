    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.trades.update", [$trade->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="requested_amount" id="requested_amount" value="{{ old('requested_amount', $trade->requested_amount) }}" step="0.000001" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="comment" id="comment" value="{{ old('comment', $trade->comment) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="failure_reason" id="failure_reason" value="{{ old('failure_reason', $trade->failure_reason) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="exchange_order_status" id="exchange_order_status" value="{{ old('exchange_order_status', $trade->exchange_order_status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="original_orders" id="original_orders" value="{{ old('original_orders', $trade->original_orders) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="exchange_order_ref" id="exchange_order_ref" value="{{ old('exchange_order_ref', $trade->exchange_order_ref) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="exchange_trade_ref" id="exchange_trade_ref" value="{{ old('exchange_trade_ref', $trade->exchange_trade_ref) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="requested_price" id="requested_price" value="{{ old('requested_price', $trade->requested_price) }}" step="0.000001" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="requested_quantity" id="requested_quantity" value="{{ old('requested_quantity', $trade->requested_quantity) }}" step="0.000001" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="executed_price" id="executed_price" value="{{ old('executed_price', $trade->executed_price) }}" step="0.000001" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="executed_amount" id="executed_amount" value="{{ old('executed_amount', $trade->executed_amount) }}" step="0.000001" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="executed_quantity" id="executed_quantity" value="{{ old('executed_quantity', $trade->executed_quantity) }}" step="0.000001" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="status" id="status" value="{{ old('status', $trade->status) }}" step="1" required>
