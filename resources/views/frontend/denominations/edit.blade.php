    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.denominations.update", [$denomination->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="denomination_type">{{ trans('cruds.denomination.fields.denomination_type') }}</label>
                            <input class="form-control" type="text" name="denomination_type" id="denomination_type" value="{{ old('denomination_type', $denomination->denomination_type) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sub_type" id="sub_type" value="{{ old('sub_type', $denomination->sub_type) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="label" id="label" value="{{ old('label', $denomination->label) }}" required>
                            @if($errors->has('label'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('label') }}
                                </div>
