    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.covers.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="index" id="index" value="{{ old('index', '') }}" step="1">
                            @if($errors->has('index'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('index') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cover_percentage" id="cover_percentage" value="{{ old('cover_percentage', '0') }}" step="0.01" min="-100">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="buy_x_times" id="buy_x_times" value="{{ old('buy_x_times', '1') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cover_pullback" id="cover_pullback" value="{{ old('cover_pullback', '0') }}" step="0.01" max="100">
