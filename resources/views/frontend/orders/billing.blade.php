                                        ...
                                        <div id="personalAddDetail" class="personalAddressForm" style="">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3 form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="building" id="building_no" value="{{$user->building_num}}">
                                                    <span class="error hide" id="building_error">Please Enter Building Number</span>
                                                </div>
                                                <div class="col-md-6 mb-3 form-group">
                                                    <label class="required" for="street">Street</label>
                                                    <input type="text" name="street" id="street" value="{{$user->street}}" class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3 form-group">
                                                    ...
                                                    <input type="text" name="region" id="region" value="{{$user->region}}" class="form-control">
                                                    <span class="error hide" id="region_error">Please Enter Region</span>
                                                </div>
                                                <div class="col-md-6 mb-3 form-group">
                                                    <label class="required" for="postcode">Postcode</label>
                                                    <input type="text" name="postcode" id="postcode" value="{{$user->postcode}}" class="form-control">
        ...
        $(document).on('click', '#order_submit', function(e) {
            ...
            if($("#stripe_payment_method").hasClass('active')){
                ...
                if(terms == false){
                    ...
                    var $form = $("#checkout_form");
                    $form.append("<input type='hidden' name='payment_mode' value='1'/>");
