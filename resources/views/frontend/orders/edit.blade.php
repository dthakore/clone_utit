                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vat" id="vat" value="{{ old('vat', $order->vat) }}">
                            @if($errors->has('vat'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('vat') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vat_number" id="vat_number" value="{{ old('vat_number', $order->vat_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="building" id="building" value="{{ old('building', $order->building) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="street" id="street" value="{{ old('street', $order->street) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="region" id="region" value="{{ old('region', $order->region) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="postcode" id="postcode" value="{{ old('postcode', $order->postcode) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="city" id="city" value="{{ old('city', $order->city) }}" required>
                            @if($errors->has('city'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('city') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="order_total" id="order_total" value="{{ old('order_total', $order->order_total) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="discount" id="discount" value="{{ old('discount', $order->discount) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="net_total" id="net_total" value="{{ old('net_total', $order->net_total) }}" required>
