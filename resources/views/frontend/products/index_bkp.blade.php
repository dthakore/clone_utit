                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-8">
                                ...
                                <div class="col-md-4">
                                    <div class="bg-white text-center">
                                        <div class="button-group">
                                            <button type="button" id="licenseBtn" onclick="licenseBtnClk()" class="btn waves-effect waves-light btn-rounded btn-primary" style="display: none; margin: auto">Proceed</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4"></div>
                            ...
                            <div class="row" id="quantity_price" style="display: none">
                                <div class="bg-gray py-2 px-3 mt-2">111Incl. VAT : EUR&nbsp;<span class="mb-0" id="product_price">{{round(($product['price'] + $product['price'] * 0.21),2)}}</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-8">
                            ...
                            <div class="bg-gray py-2 px-3 mt-2">
                                Incl. VAT : EUR&nbsp;<span class="mb-0" id="product_price">
                                <?= round(($product['price'] + $product['price'] * 0.21),2);?>
                            </span>
                                <input type="hidden" name="originalPrice" value="<?= $product['price']; ?>" class="originalPrice">
                            </div>
                            <div class="quantity mt-3">
                            ...
                            @if($has_platform == 0)
                                <br>
                                <a class="nav-item active">Make sure you have sufficient platform for bots</a>
                                ...
                                <select required class="form-control required" style="width: 100%;" id="botPrice"
                                        tabindex="-1" aria-hidden="true">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var min_node_amount = {{ env('MinimumNodeAmount') }};
        ...
        function updateSpinnerDetails(licenseQty, price_license) {
            ...
            $('#product_price').text((price_license * licenseQty) + (price_license * licenseQty * 0.21));
        }
        ...
        function touchSpinLicenseChange(licenseCount) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    console.log(data);
                    window.sale_price = dt.product_price;
                    $('#product_price').text((window.sale_price * licenseCount) + (window.sale_price * licenseCount * 0.21));
                }
            });
        }
