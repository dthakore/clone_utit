    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.shipment-infos.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="order">{{ trans('cruds.shipmentInfo.fields.order') }}</label>
                            <input class="form-control" type="text" name="order" id="order" value="{{ old('order', '') }}">
                            @if($errors->has('order'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="shipment_number" id="shipment_number" value="{{ old('shipment_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tracking_number" id="tracking_number" value="{{ old('tracking_number', '') }}">
