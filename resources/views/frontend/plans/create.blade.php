                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.plans.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="table_name" id="table_name" value="{{ old('table_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="action_name" id="action_name" value="{{ old('action_name', '') }}">
