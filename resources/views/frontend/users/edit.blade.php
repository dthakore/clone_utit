                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="building_num" id="building_num" value="{{ old('building_num', $user->building_num) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="region" id="region" value="{{ old('region', $user->region) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="postcode" id="postcode" value="{{ old('postcode', $user->postcode) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bus_address_building_num" id="bus_address_building_num" value="{{ old('bus_address_building_num', $user->bus_address_building_num) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bus_address_street" id="bus_address_street" value="{{ old('bus_address_street', $user->bus_address_street) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bus_address_region" id="bus_address_region" value="{{ old('bus_address_region', $user->bus_address_region) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bus_address_city" id="bus_address_city" value="{{ old('bus_address_city', $user->bus_address_city) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="bus_address_postcode" id="bus_address_postcode" value="{{ old('bus_address_postcode', $user->bus_address_postcode) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="business_phone" id="business_phone" value="{{ old('business_phone', $user->business_phone) }}">
